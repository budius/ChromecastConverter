...
class FormatTags {
  ...
  FormatTags(this.title, this.encoder, this.creation_time);

  factory FormatTags._fromMap(Map<String, dynamic> m) {
    return FormatTags(m['title'], m['encoder'], m['creation_time']);
  }
}
